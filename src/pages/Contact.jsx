...
export default function Contact() {
  return (
    <div className='contact__container'>
        <h1 className='text-2xl mt-20 font-semibold text-center'>Contact Us</h1>
    ...
    <div className="h-screen w-full grid place-items-center bg-slate-100">
        <div className="bg-white rounded-md shadow-md flex flex-row">
            ...
            <div className="flex-1 bg-orange-400 p-8 lg:px-10 md:hover:scale-y-110 rounded-md transition md:block" id="contact_info">
                ...
                <div className="mt-4 flex flex-row">
                    ...
                    <div>
                        ...
                        <p className="text-white text-xs">davidwarner323@xyz.com</p>
                    </div>
                </div>
            ...
            {/* get in touch form */}
            <div className="flex-1 px-6 py-8 lg:py-24 lg:px-10" id="contact_us">
                <div className="flex justify-between">
                    <h2 className="text-orange-600 text-xl">Get In Touch</h2>
                    <h2 className="text-orange-600 text-xs flex flex-row md:hidden block cursor-pointer" id="swtich_to_contact_info">Contact Info <svg
                            xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" viewBox="0 0 20 20"
                            fill="currentColor">
                            <path fill-rule="evenodd"
                                d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"
                ...
                <input type="submit" value="Send"
                    className="bg-orange-400 px-4 py-2 rounded-md text-white text-xs cursor-pointer hover:shadow-md" />
            </div>
        </div>
    </div>
    </div>
